...
| Prompt Engineer | [prompt-engineer.md](prompt-engineer.md) | Criar ou otimizar prompts do system/user para Groq, ajustar tom de voz, melhorar qualidade das respostas de IA. |
| Integration Specialist | [integration-specialist.md](integration-specialist.md) | Configurar, debugar ou trocar integracoes (Z-API, Groq, webhooks). Adicionar novas APIs ou canais de comunicacao. |
